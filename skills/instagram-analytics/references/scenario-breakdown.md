...
## Дословный перевод (перед разбором)
Если `transcript` не на русском — переведи его **дословно** на русский в поле `transcript_ru` (и секцию `## Транскрипт (RU)`): максимально близко к оригиналу, без пересказа и без «причёсывания», сохраняя смысл каждой фразы. Это перевод силами LLM (не API), дёшево. Оригинал уже на русском → `transcript_ru` пусто.
